...
(function (factory) {
    ...
    function onReset(event) {
        ...
        $form.find(".invalid-feedback").addClass("field-validation-valid").removeClass("invalid-feedback").removeData("unobtrusiveContainer").find(">*") // If we were using valmsg-replace, get the underlying error
